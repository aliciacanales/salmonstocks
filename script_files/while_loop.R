...
## There is probably a more efficient way to do this lol
...
bpassage_invest_df <- bpassage_invest_fcn(bpassage_invest_output) # working
...
temp2 = map_df(.x=index_choice_list,~output_bpassage_fcn(.x)) # not working
